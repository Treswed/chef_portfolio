...
# echo "[entrypoint] running Django migrations"
# python manage.py migrate || { echo "Migration failed"; exit 128; }

# echo "[entrypoint] creating Django superuser"
# python manage.py shell << END || { echo "Superuser creation failed"; exit 128; }
# from django.contrib.auth import get_user_model
# User = get_user_model()
# username = 'sensei'
# email = 'sensei@gmail.com'
...
# echo "[entrypoint] starting gunicorn"
# exec gunicorn chef_site.wsgi:application --bind 0.0.0.0:8000